...
abstract class UserFormMap {
  static const Map<String, FormEntity> userFormMap = {
    ...
    CommonFormMapKey.age: FormEntity<int>(value: 0, validation: UserFormValidator.validateAge, parser: int.tryParse),
    CommonFormMapKey.agreement: FormEntity<bool>(value: false, validation: UserFormValidator.validateAgreement),
    CommonFormMapKey.gender: FormEntity<GenderEnum>(value: GenderEnum.other, validation: UserFormValidator.alwaysValidate),
  };
}
