...
class _$UserEntityImpl implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(email: $email, password: $password, age: $age, agreement: $agreement, gender: $gender)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, age, agreement, gender);
...
abstract class _UserEntity implements UserEntity {
  const factory _UserEntity(
      ...
      required final bool agreement,
      required final GenderEnum gender}) = _$UserEntityImpl;
